...
target_alias=x86_64-monolith64
target_vendor=pc
target_os=monolith64
target=x86_64-pc-monolith64

program_transform_name = s&^&x86_64-monolith64-&
...
TOPLEVEL_CONFIGURE_ARGUMENTS=../newlib-4.5.0.20241231/configure --prefix=/usr --target=x86_64-monolith64

tooldir = ${exec_prefix}/x86_64-monolith64
build_tooldir = ${exec_prefix}/x86_64-monolith64
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/usr' --program-transform-name='s&^&x86_64-monolith64-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-system-zlib --with-newlib '--prefix=/usr' --program-transform-name='s&^&x86_64-monolith64-&' --disable-option-checking
...
TARGET_SUBDIR = x86_64-monolith64
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --with-newlib --enable-multilib --with-cross-host=x86_64-pc-linux-gnu   '--prefix=/usr' --program-transform-name='s&^&x86_64-monolith64-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AS = as
AR = ar --plugin /usr/lib/gcc/x86_64-pc-linux-gnu/15.2.1/liblto_plugin.so
AR_FLAGS = rc
CC = gcc
CXX = g++
DLLTOOL = dlltool
...
OBJCOPY = objcopy
OBJDUMP = objdump
RANLIB = ranlib --plugin /usr/lib/gcc/x86_64-pc-linux-gnu/15.2.1/liblto_plugin.so
READELF = readelf
STRIP = strip
WINDRES = windres
WINDMC = windmc
...
AR_FOR_TARGET=x86_64-monolith64-ar
AS_FOR_TARGET=x86_64-monolith64-as
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) x86_64-monolith64-gcc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) x86_64-monolith64-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) x86_64-monolith64-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) x86_64-monolith64-c++
GCJ_FOR_TARGET=$(STAGE_CC_WRAPPER) x86_64-monolith64-gcj
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) x86_64-monolith64-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) x86_64-monolith64-gccgo
DLLTOOL_FOR_TARGET=x86_64-monolith64-dlltool
LD_FOR_TARGET=x86_64-monolith64-ld

LIPO_FOR_TARGET=x86_64-monolith64-lipo
NM_FOR_TARGET=x86_64-monolith64-nm
OBJDUMP_FOR_TARGET=x86_64-monolith64-objdump
OBJCOPY_FOR_TARGET=x86_64-monolith64-objcopy
RANLIB_FOR_TARGET=x86_64-monolith64-ranlib
READELF_FOR_TARGET=x86_64-monolith64-readelf
STRIP_FOR_TARGET=x86_64-monolith64-strip
WINDRES_FOR_TARGET=x86_64-monolith64-windres
WINDMC_FOR_TARGET=x86_64-monolith64-windmc
...
FLAGS_FOR_TARGET =  -B$$r/$(TARGET_SUBDIR)/newlib/ -isystem $$r/$(TARGET_SUBDIR)/newlib/targ-include -isystem $$s/newlib/libc/include -B$$r/$(TARGET_SUBDIR)/libgloss/x86_64 -L$$r/$(TARGET_SUBDIR)/libgloss/libnosys -L$$s/libgloss/x86_64
